...
# Create a config file to change the methods used in some methods such as
# transcript identification, transcript quantification
...
gRNA-cell barcode mapping files, identifying which gene has been knocked out in each cell.
```{r}
gRNA_assign(
